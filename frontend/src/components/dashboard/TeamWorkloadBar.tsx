    ...
    <div className="flex items-center gap-2 py-1">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between mb-1">
          <span className="text-[16px] text-neutral-700 truncate">{user.displayName}</span>
          <span className="text-[16px] text-neutral-400 flex-shrink-0 ml-2">
            {taskCount} tasks
