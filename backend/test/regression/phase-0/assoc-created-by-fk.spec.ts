...
// The pre-1.0 numbered migrations (including 022 and 026, which set up this
// FK) were squashed into a single Baseline migration. The entity-generated
// Baseline carries the SET NULL FK under an auto-generated name;
// RestoreAuditHardening renames it to the audited FK_assoc_created_by. This
// spec runs the post-squash set and asserts the resulting final schema.
