...
Trackero is a self-hosted, real-time project management application for small-to-mid-size product teams. Sprints, epics, stories, Kanban boards, retrospectives, charts, full-text search, file attachments, role-based access, in-app notifications, and a keyboard-first interface. Not a prototype. Not a demo. **157 API endpoints across 36 feature areas, 35 database tables, 22 pages.**
